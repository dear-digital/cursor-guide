...
export function CollectionCard(props: {
  ...
  const cardContentClass = cn(
    'flex flex-wrap items-center py-4 text-base',
    textAlignment === 'center'
      ? 'justify-center'
      : textAlignment === 'right'
        ? 'justify-end'
      ...
      <Card className={cardClass}>
        ...
        <CardContent className={cardContentClass}>
          <div className="flex items-center">
            <span className="relative z-[2] block pr-2 text-base w-fit overflow-hidden text-ellipsis pb-4 font-bold leading-tight text-contentPrimary">
              {collection.title}
            </span>

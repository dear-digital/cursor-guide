      ...
      <div className="flex gap-4 py-5">
        ...
        <div className="flex flex-1 justify-between">
          <div className="grid gap-1">
            <h3 className="font-body text-base font-medium lg:text-xl">
            ...
            <div className="hidden">
              {line?.attributes?.find(
                (attribute) => !attribute.value?.includes('_'),
              ) && (
                <div className="grid pb-2">
                  {(line?.attributes || []).map((attribute) => (
                    <small className="text-sm opacity-80" key={attribute.key}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IconRemove aria-hidden="true" className="h-8 w-8" />
      </IconButton>
...
export function UpdateCartForm({
  children,
  lines,
}: {

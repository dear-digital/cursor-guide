...
import type {COLLECTION_PRODUCT_GRID_SECTION_FRAGMENT} from '~/qroq/content-blocks/collectionProductGridSectionFragment';
          ...
          return (
            <div className="container">
              {props.data.title && props.data.title.title && (
                <div className="pb-5 text-center text-xl font-light lg:pb-10 lg:text-5xl">
                  <TitleRenderer data={{title: props.data.title}} />
                </div>
              )}
              <SortFilter
                  ...
                  {({
                    ...
                    <>
                      ...
                      <ProductsLoadedOnScroll
                        ...
                        state={state}
                      />
                      <div className="my-8 flex w-full items-center justify-center text-center lg:my-16">
                        <NextLink>
                          <div className="w-fit rounded-lg bg-primary p-4 text-white empty:hidden">
                            {isLoading
                              ? themeContent?.collection?.loading

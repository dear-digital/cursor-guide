...
import {Button, ShoppingCart} from '@vorwerk/fibre-react';
      ...
      <>
            ...
            return (
              <div className="grid gap-3">
                ...
                <Button
                  ...
                  invertColors={false}
                  size={'medium'}
                  // @todo: Uncomment when we have a proper form handling
                  // type="submit"
                >
                  {showButtonText &&
                    (isOutOfStock ? (
        ...
        {showAlmaPayment && (
          <AlmaPayment
            ...
            merchantId={'merchant_11zVWQ22MEBwRXqpBdwp6OTqqdq4x7OpOi'}

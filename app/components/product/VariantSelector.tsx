...
import {useCookBookSelectedVariant} from '~/lib/utilities/useCookBookSelectedVariant';

import {useSection} from '../content-blocks/ContentBlockComponent';
...
export function VariantSelector(props: {
  ...
  const selectedVariant = useCookBookSelectedVariant({
...
function Pill(props: {
  ...
  const buttonClass = cx([
    'select-none rounded-full text-sm font-medium disabled:cursor-pointer',
  ...
  const foregroundClass = cx([
    'inline-flex items-center relative z-[2] justify-center whitespace-nowrap px-4 py-2 transition-colors notouch:hover:text-accent-foreground',

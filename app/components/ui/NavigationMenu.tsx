...
>(({className, ...props}, ref) => (
  <NavigationMenuPrimitive.List
    className={cn(
      'group flex flex-1 list-none items-center justify-center space-x-1 px-10 py-3 rounded-button bg-white',
      className,
    )}
    ref={ref}
    {...props}

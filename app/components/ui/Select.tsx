...
>(({children, className, ...props}, ref) => (
  <SelectPrimitive.Trigger
    className={cn(
      'flex w-full items-center justify-between bg-background p-3 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <IconChevron className="size-6 opacity-50" direction="down" />

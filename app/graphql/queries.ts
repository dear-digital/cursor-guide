...
query Product(
  ...
  product(handle: $handle) {
    ...
    metafields(
      identifiers: [
        {key: "product_specifications", namespace: "custom"}
        {key: "product_downloads", namespace: "custom"}
        {key: "product_highlights", namespace: "custom"}
      ]
    ) {
      key
      value
...
export const ADVISOR_QUERY = `#graphql
query ($first: Int!, $after: String) {
  metaobjects(type: "advisors", first: $first, after: $after) {
    edges {
      node {
        id
        fields {
...
export const ALL_PRODUCTS_QUERY = `#graphql
  query AllProducts(
    ...
    products(first: $first, last: $last, before: $startCursor, after: $endCursor, query: "tag_not:hide_product") {
      nodes {
        ...ProductCard
      }
      pageInfo {
